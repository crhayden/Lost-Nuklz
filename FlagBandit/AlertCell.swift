...
class AlertCell: UITableViewCell
{
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?)
    {
        ...
        bubbleImageView.addSubview(alertLabel)
        
        alertLabel.centerXAnchor.constraintEqualToAnchor(bubbleImageView.centerXAnchor).active = true
        alertLabel.centerYAnchor.constraintEqualToAnchor(bubbleImageView.centerYAnchor).active = true
        
        bubbleImageView.widthAnchor.constraintEqualToAnchor(alertLabel.widthAnchor, constant:50).active = true
        bubbleImageView.heightAnchor.constraintEqualToAnchor(alertLabel.heightAnchor, constant:20).active = true
