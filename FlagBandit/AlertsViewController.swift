...
class AlertsViewController: UIViewController
{
    ...
    override func viewDidLoad()
    {
        ...
        tableView.registerClass(AlertCell.self, forCellReuseIdentifier: cellIdentifier)
...
extension AlertsViewController: UITableViewDataSource
{
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell
    {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier(cellIdentifier, forIndexPath:indexPath) as! AlertCell
        cell.backgroundColor = UIColor.lightGrayColor()
        cell.separatorInset = UIEdgeInsetsMake(0, tableView.bounds.size.width, 0, 0)
        let messages = getMessages(indexPath.section)

        let message  = messages[indexPath.row]
        cell.alertLabel.text = message.text
